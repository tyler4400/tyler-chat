  ...
  <div class="settings w-[80%] mx-auto p-8">
    ...
    <div class="space-y-6">
      <div class="setting-item">
        ...
        <SelectRoot v-model="currentConfig.language" class="select-root">
          <SelectTrigger class="w-44 flex items-center justify-between rounded-md px-3 py-2 text-sm gap-1 bg-white border border-gray-300">
      ...
      <div class="setting-item">
        ...
        <NumberFieldRoot v-model="currentConfig.fontSize" class="number-root inline-flex">
          <NumberFieldDecrement class="px-2 border border-r-0 border-gray-300 rounded-l-md hover:bg-green-100 focus:outline-none">
            <Icon icon="radix-icons:minus" />
          </NumberFieldDecrement>
          <NumberFieldInput
              class="number-input w-[60px] px-3 py-2 border border-gray-300 focus:outline-none focus:ring-1 focus:ring-green-500 text-center"
              :min="12"
              :max="20"
          />
          <NumberFieldIncrement class="px-2 border border-l-0 border-gray-300 rounded-r-md hover:bg-green-100 focus:outline-none">
