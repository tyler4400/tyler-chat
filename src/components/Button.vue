...
const colorVariants: Record<ButtonColor, any> = {
  'green' : {
    plain: 'bg-green-50 text-green-700 hover:bg-green-700 border border-green-700 hover:text-white active:bg-green-800',
    normal: 'bg-green-700 text-white hover:bg-green-700/90 border border-green-700 active:bg-green-800'
  },
  'purple': {
